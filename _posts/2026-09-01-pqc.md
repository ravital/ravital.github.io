...
![NIST timeline](https://github.com/ravital/ravital.github.io/blob/master/timeline1.png)
...
|  Name     | Category | Cryptography     | Benefits | Drawback |
| :---        |    :----:   |        :---: | :---: | ----: |
...
| SPHINCS+ ([FIPS 205](https://csrc.nist.gov/Projects/post-quantum-cryptography)) | Digital signature | Hash | Most mature cryptography | Slow and large |
...
| HQC (FIPS tbd) | KEM | Code | Mature cryptography | Weak performance |

#### KEMs

CRYSTALS-Kyber (renamed ML-KEM by NIST), [as noted by NIST](https://nvlpubs.nist.gov/nistpubs/ir/2025/NIST.IR.8545.pdf), relies on hardness assumptions spanning over a decade of research (thus giving them confidence in its security). It also offers relatively fast key generation times, encapsulation times, and decapsulation times. In terms of public key and ciphertext sizes, the are around 1000 bytes.

HQC, while much less performant than CRYSTALS-Kyber with larger public keys and ciphertexts, serves as a *non*-lattice based alternative. Essentially, it was the best of the non-lattice based options.
