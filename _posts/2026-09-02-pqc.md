...
If you follow [ePrint](https://eprint.iacr.org/), [ZK Podcast](https://zeroknowledge.fm/), or one of the many other sources covering cryptography research, you'll notice there are new cryptographic schemes being proposed on a monthly (if not weekly) basis. Many of these works improve on efficiency and appear in prestigious venues like [Eurocrypt](https://eurocrypt.iacr.org/) or [S&P](https://sp2027.ieee-security.org/). We often get asked about the process of going from academic paper to production and why we can't we just deploy these new peer-reviewed works. 
